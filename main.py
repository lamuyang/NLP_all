...
print("start final")
# 去除以...為例子
for i in range(0,len(raw_title)):
    raw_title[i] = remove_line(raw_title[i])
CKIP_WIKI_Ngram_keyword_WS_name = ws_to_list(raw_title,"./PklData/final_CKIP_WIKI_Ngram_keyword_WS_name.pkl",WIKI_DIC,ngram_keyword_dic)
